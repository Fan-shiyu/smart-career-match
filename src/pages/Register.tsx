      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg border-border/60">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>Start finding your perfect job match</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="Min 6 characters" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-9 h-9" required minLength={6} />
                </div>
              </div>
